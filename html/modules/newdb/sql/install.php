<?php
	...
	function xoops_module_install_newdb($xoopsMod){
		...
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('1', 'ID', 'ID', '', '1', '', '', '0', '0')";
		$rs = $xoopsDB->query($sql);
		
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('2', '"._ND_INS_DATAN."', 'Data Name', '', '1', '', '', '0', '0')";
		$rs = $xoopsDB->query($sql);
		
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('3', '"._ND_INS_AUTHOR."', 'Author', '', '1', '', '', '0', '0')";
		$rs = $xoopsDB->query($sql);
		
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('4', '"._ND_INS_DATE."', 'Creation Date', '', '1', '', '', '0', '0')";
		$rs = $xoopsDB->query($sql);
		
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('5', '"._ND_INS_VIEWS."', 'Views', '', '1', '', '', '0', '0')";
		$rs = $xoopsDB->query($sql);
		
		$sql = "INSERT INTO ".$xoopsDB->prefix('newdb_component_master')." VALUES ('6', '"._ND_INS_RANK."', 'Rank', '', '2', '--', 'A,B,C,D,--', '0', '0')";
		$rs = $xoopsDB->query($sql);
