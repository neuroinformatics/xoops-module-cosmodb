...
if ($method == 2) {
    ...
    if ($sort == 1) {
        ...
        if ($p - 1 >= 0 && $p - 1 < count($cid3) && $p + 1 >= 0 && $p + 1 < count($cid3)) {
            echo ' | ';
        }
...
// thread
if ($method == 2) {
    echo "<br><br><table class='list_table'><tr><th>"._ND_COMMENTV_SRED2.'</th><th>'._ND_COMMENTV_POSTER.'</th><th>'._ND_COMMENTV_DATE
         .'</th></tr>';
    foreach ($show as $key => $value) {
