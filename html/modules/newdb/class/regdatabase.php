...
class regdatabase
{
     ...
     * @return bool
     */
    public function setRegLabel($label, $extract_path, $uid)
    {
        $this->label = $label;
        $this->uid = $uid;
    ...
    public function setLabel($labelid, $uid)
    {
     ...
     */
    public function __regItems($dir)
    {
    ...
    public function regFile($fname, $did)
    {
    ...
    public function synchroDatabase()
    {
